...
description: "Advanced machine learning system that identifies coffee plant diseases (Cercospora, Leaf Rust, Miner, Phoma) from leaf images using multiple CNN architectures including VGG16, EfficientNet, and custom CNN models. The project consists of two repositories: the main API and models repository, and a separate web frontend repository available at https://github.com/fermx3/coffeedd-web."
...
- **Separate web frontend repository** available at [https://github.com/fermx3/coffeedd-web](https://github.com/fermx3/coffeedd-web) for the Streamlit application
