...
description: "Sistema avanzado de machine learning que identifica enfermedades de plantas de café (Cercospora, Roya, Minador, Phoma) a partir de imágenes de hojas usando múltiples arquitecturas CNN incluyendo VGG16, EfficientNet y modelos CNN personalizados."
